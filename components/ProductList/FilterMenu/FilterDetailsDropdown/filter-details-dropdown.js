...
export default function FilterDetailsDropdown({dropdownId, dropdownTitle, children}){

    const [isExpanded, setIsExpanded] = useState(false);

    return(
        <details id={dropdownId} className="py-4 w-full border-b border-grey-lighter cursor-pointer">
