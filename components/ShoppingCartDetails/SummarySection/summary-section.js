    ...
    return(
        <div className="w-full md:w-2/5 flex flex-col items-start justify-center gap-4 my-8">
            ...
            <div className="w-full flex flex-col items-center justify-center border-t border-grey-lighter mt-16">
                ...
                <button onClick={() => console.log(localStorage.getItem('localShoppingCart'))} className="bg-black w-full text-white py-3 px-3 rounded rounded-md text-sm hover:bg-gray-800">
                    CHECKOUT NOW
                </button>
            </div>
        </div>
