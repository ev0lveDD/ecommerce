export default function ColorPickInput({colorName, colorPicked, setColorPicked, colorNameCSS, colorPickInputId}) {
    ...
    return(
        <div className="flex items-center relative">
            <label className={colorPicked===colorName ? colorPickActive : colorPickNotActive}>
                <input id={colorPickInputId} type="radio" value="" name="color-radio" className="sr-only" onClick={selectColorButton}></input>
