    ...
    return(
        <Link href={'/MenProductDetails'}>
            <div className="flex flex-col gap-2 justify-center items-start cursor-pointer relative" onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
                {isHovering ? 
                <Image className="w-full h-full object-fill" alt="product image" src={itemImage1} width={96} height={20}/> : 
                <Image className="w-full h-full object-fill" alt="product image" src={itemImage2} width={96} height={20}/>
                }
