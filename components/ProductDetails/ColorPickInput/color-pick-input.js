export default function ColorPickInput({colorName, colorPicked, setColorPicked, colorNameCSS}) {
    ...
    const colorPickNotActive = "relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 focus:outline-none ring-0 hover:ring hover:ring-gray-200 hover:ring-offset-1"
