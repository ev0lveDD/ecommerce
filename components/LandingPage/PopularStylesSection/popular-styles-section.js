...
export default function PopularStylesSection() {
    return(
        <div className="w-4/5 flex items-center justify-center">
            <p className="-rotate-90 font-medium text-sm">EXPLORE NEW AND POPULAR STYLES</p>
            <div className="w-4/5 grid grid-cols-4 grid-rows-2 gap-4 items-start">
                <div className="col-span-2 row-span-2">
                    <Image src={style1} alt="First Popular Style"/>
                </div>

                <div className="col-start-3 w-full h-full">
                    <Image src={style2} alt="Second Popular Style" className="m-0 p-0 w-full h-full"/>
                </div>

                <div className="col-start-4 w-full h-full">
                ...
                <div className="col-start-4 row-start-2 w-full h-full">
