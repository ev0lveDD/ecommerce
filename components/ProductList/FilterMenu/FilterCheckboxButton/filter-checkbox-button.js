...
export default function FilterCheckboxButton({filterFieldName, filterFieldId, filterValue, filterChangeValue}) {
    ...
    return(
        <div className="flex items-center my-4 gap-2">
            ...
            <label htmlFor={filterFieldId} className="z-0 flex items-center justify-start w-auto bg-white cursor-pointer hover:text-gray-800 peer-checked:font-bold" onClick={() => {setIsCheckboxchecked(!isCheckboxChecked); setFilterValue()}}>
