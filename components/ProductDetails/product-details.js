        ...
        <div className="bg-white min-w-screen flex items-center justify-center">
            <div className="w-11/12 grid grid-cols-2 gap-4">
                <div className="w-full flex flex-col gap-4 items-center justify-start">
                    <Image className="w-full h-1/2" alt="big item image" src={crewNeck1}/>
                ...
                <div className="w-full flex flex-col gap-4 my-8">
                    ...
                    <p className="text-slate-600">
                        Hinting at the brand's penchant for logomania, Balmain presents this sweatshirt as part of its SS23 offering. Crafted from cotton, the long-sleeved design is adorned with a contrasting logo print at the chest.
                    </p>
                    {/* Color Pick section */}
                    <div>
